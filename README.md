...
[![pages](https://img.shields.io/badge/live-baditaflorin.github.io%2Fmesh-would-rather-ffb14d)](https://baditaflorin.github.io/mesh-would-rather/)
...
**Source → https://github.com/baditaflorin/mesh-would-rather**
...
git clone https://github.com/baditaflorin/mesh-would-rather
cd mesh-would-rather
npm install
npm run dev
```
...
- `mesh-would-rather:signalingUrl`
- `mesh-would-rather:turnTokenUrl`
- `mesh-would-rather:iceServers`
- `mesh-would-rather:room`
